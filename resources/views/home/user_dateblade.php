...
<!--pagename埋点 end-->
	...
	<script type="text/javascript">
    	...
    	var service = "https://aq.suning.com/asc/auth?targetUrl=https%3A%2F%2Fmy.suning.com%2F";
    	var oauth_redirect = "";
	    ...
	    var userTargetUrl = "?loginTheme=b2c&service=https%3A%2F%2Faq.suning.com%2Fasc%2Fauth%3FtargetUrl%3Dhttps%253A%252F%252Fmy.suning.com%252F".split("targetUrl%3D")[1];
		...
		//QQ联合登录
		function qqLogin(){
			var qq = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101224012&redirect_uri=https%3A%2F%2Fpassport.suning.com%2Fids%2Flogin%3Foauth_provider%3DQQProvider&state=https%3A%2F%2Faq.suning.com%2Fasc%2Fauth%3FtargetUrl%3Dhttps%253A%252F%252Fmy.suning.com%252F";
			if(service.length>0){
		...
		//易付宝联合登录
		function eppLogin(){
			var epp ="https://paypassport.suning.com/ids/oauth20/authorize?client_id=suning_01&response_type=code&redirect_uri=https%3A%2F%2Fpassport.suning.com%2Fids%2Flogin%3Foauth_provider%3DEppProvider&state=https%3A%2F%2Faq.suning.com%2Fasc%2Fauth%3FtargetUrl%3Dhttps%253A%252F%252Fmy.suning.com%252F";
			if(service.length>0){
		...
		var checkTrustCookie = function() {
			...
			if ( trustbinding!=null && trustbinding!=""){
				...
				var serviceStr=decodeURIComponent("https://aq.suning.com/asc/auth?targetUrl=https%3A%2F%2Fmy.suning.com%2F");
				//已解码
		...
		function fun_getVcode() {
			...
			if($('#imageCode1').length > 0){
				$('#imageCode1')[0].src = 'https://vcs.suning.com/vcs/imageCode.htm?uuid='
					+ "acd8b9df-6f56-4324-a115-9ae555cb18f0" + "&sceneId=logonImg&yys=" + new Date().getTime();
			}
		...
		function ajaxCheckVerifyCodeOrSubmit(isSubmit) {
			if(isUseSlideVerifycode){
				...
				var param = {
						code : code,
						uuid : "acd8b9df-6f56-4324-a115-9ae555cb18f0",
						delFlag : 0
				};
				$.ajax({
					//请求类型
		...
		function submitSnaphotForm(){
			...
			if(needVerifyCodeVal){
			  var uuid = "acd8b9df-6f56-4324-a115-9ae555cb18f0";
		...
		function ajaxLogonSubmit(){
			...
			var param = {
					...
					password2 : pwd2,
					loginTheme:"b2c",
					service:"https://aq.suning.com/asc/auth?targetUrl=https%3A%2F%2Fmy.suning.com%2F",
					//oauth_redirect:"",
					//trust_redirect:"",
			...
			if(needVerifyCodeVal){
				if(isUseSlideVerifycode){
					...
					param.uuid = "acd8b9df-6f56-4324-a115-9ae555cb18f0";
		    	}
			}
			//登陆中
