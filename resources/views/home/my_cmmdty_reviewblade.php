...
<!--pagename埋点 end-->
	...
	<script type="text/javascript">
    	...
    	var service = "https://aq.suning.com/asc/auth?targetUrl=https%3A%2F%2Freview.suning.com%2Fmy_cmmdty_review.do";
    	var oauth_redirect = "";
	    ...
	    var userTargetUrl = "?loginTheme=b2c&service=https%3A%2F%2Faq.suning.com%2Fasc%2Fauth%3FtargetUrl%3Dhttps%253A%252F%252Freview.suning.com%252Fmy_cmmdty_review.do".split("targetUrl%3D")[1];
		...
		//QQ联合登录
		function qqLogin(){
			var qq = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101224012&redirect_uri=https%3A%2F%2Fpassport.suning.com%2Fids%2Flogin%3Foauth_provider%3DQQProvider&state=https%3A%2F%2Faq.suning.com%2Fasc%2Fauth%3FtargetUrl%3Dhttps%253A%252F%252Freview.suning.com%252Fmy_cmmdty_review.do";
			if(service.length>0){
		...
		var checkTrustCookie = function() {
			...
			if ( trustbinding!=null && trustbinding!=""){
				...
				var serviceStr=decodeURIComponent("https://aq.suning.com/asc/auth?targetUrl=https%3A%2F%2Freview.suning.com%2Fmy_cmmdty_review.do");
				//已解码
		...
		function fun_getVcode() {
			...
			if($('#imageCode1').length > 0){
				$('#imageCode1')[0].src = 'https://vcs.suning.com/vcs/imageCode.htm?uuid='
					+ "190097bc-8cbf-47eb-9a91-8c9828461fd9" + "&sceneId=logonImg&yys=" + new Date().getTime();
			}
		...
		function ajaxCheckVerifyCodeOrSubmit(isSubmit) {
			if(isUseSlideVerifycode){
				...
				var param = {
						code : code,
						uuid : "190097bc-8cbf-47eb-9a91-8c9828461fd9",
						delFlag : 0
				};
				$.ajax({
					//请求类型
		...
		function submitSnaphotForm(){
			...
			if(needVerifyCodeVal){
			  var uuid = "190097bc-8cbf-47eb-9a91-8c9828461fd9";
		...
		function ajaxLogonSubmit(){
			...
			var param = {
					...
					password2 : pwd2,
					loginTheme:"b2c",
					service:"https://aq.suning.com/asc/auth?targetUrl=https%3A%2F%2Freview.suning.com%2Fmy_cmmdty_review.do",
					//oauth_redirect:"",
					//trust_redirect:"",
			...
			if(needVerifyCodeVal){
				if(isUseSlideVerifycode){
					...
					param.uuid = "190097bc-8cbf-47eb-9a91-8c9828461fd9";
		    	}
			}
			//登陆中
