    ...
    <div class="zhuce_kong">
        <div class="zc">
            ...
            <!-- onsubmit="return false;" -->
                <form action="{{ url('home/dobackpass') }}"  method="post" >
                    {{ csrf_field() }}
                    <input name="phone" type="text" class="kuang_txt phone" placeholder="手机号" style="margin-top:40px;">
                    <input name="code" type="text" class="kuang_txt yanzm" placeholder="手机验证码" style="margin-top:10px;">
                    ...
                    <input type="submit" class="btn_zhuce" value="提交">
                </form>
            </div>
            <div class="bj_right">
                <p>使用邮箱注册</p>
                ...
                <p> 想起来了 ! ! ! <a href="{{ url('/home/login') }}">返回登录</a></p>
            </div>
        </div>
    </div>
</body>
