                                ...
                                <td>
                                    <div class="layui-input-block">
                                        @foreach($v->permission as $v1)
                                          ...
                                          @foreach($role_permission as $m)
                                            @if($m->permission == $v1->permission)
                                              layui-form-checked
                                            @endif
                                          @endforeach
                                          " lay-skin="" permission-id="{{$v1->id}}"><i class="layui-icon"></i></div> {{$v1->permission}}
                                        @endforeach
                                    </div>
                                </td>
                            </tr>
