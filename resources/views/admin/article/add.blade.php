        ...
        <form  id="art_form" action="{{ url('admin/article') }}" method="post" enctype="multipart/form-data">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_id">
                            <option value='0' name="公告">公告</option>
                            <option value="1" name="指南" >指南</option>
                            <option value="2" name="回收" >回收</option>
                            <option value="3" name="热销" >热销</option>
                            <option value="4" name="资讯" >资讯</option>
...
//                            判断是否有选择上传文件
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" type="text/plain" name="content" style="width:600px;height:50px;"></script>
                        <script type="text/javascript">
                ...
                <th>排序：</th>
                    <td>
                        <input type="text" class="sm" name="number"><b style="color:blue">*请您输入数字</b>
                    </td>
                <tr>
                    <th></th>
                    <td>
