        ...
        <form action="" method="post" class="layui-form layui-form-pane">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" placeholder="{{$permission->permission}}">
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="layui-input-block">
                                        <input class="layui-input" name="urls" type="text" placeholder="{{$permission->urls}}">
                                    </div>
                                </td>
                            </tr>
                            <tr>
