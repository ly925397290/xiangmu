...
<table class="table">
    <tr>
        ...
        <td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="/admin/cates/create"></iframe></td>
    </tr>
</table>
<!--_footer 作为公共模版分离出去-->
...
<script type="text/javascript">
    ...
    var zNodes = [
        ...
        {id:{{$cate->id}},pId:{{$cate->pid}},name:"{{$cate->name}}"},
         @endforeach
    ]
    var code;
